...
impl OkIcon {
    ...
    pub fn from_key(key: &str) -> Self {
        match key.to_ascii_lowercase().as_str() {
            ...
            "qq_group" | "qq_channel" | "qq" => Self::Chat,
            "sponsor" | "heart" => Self::HeartMark,
            "share" => Self::ShareMark,
            "download" => Self::ArrowDownload,
            "faq" => Self::QuestionCircle,
            "info" => Self::Info,
